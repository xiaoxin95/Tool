package com.unipock.unipaytool.adapter;
...
public class SmartViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    SmartViewHolder(View itemView, AdapterView.OnItemClickListener mListener) {
        super(itemView);
...
//        }
    ...
    public SmartViewHolder textBackground(int id, int drawableId) {
        View view = findViewById(id);
        if (view instanceof TextView) {
            ((TextView) view).setBackground(view.getContext().getResources().getDrawable(drawableId));
        }
        return this;
    }

    public SmartViewHolder backgroundColor(int id, int color) {
        View view = findViewById(id);
