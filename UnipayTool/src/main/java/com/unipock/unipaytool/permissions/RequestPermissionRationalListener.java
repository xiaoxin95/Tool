package com.unipock.unipaytool.permissions;
...
public interface RequestPermissionRationalListener {
     ...
     * @param nextAction
     */
    void onRequestPermissionRational(String permission, boolean requestPermissionRationaleResult, NextAction nextAction);
}
